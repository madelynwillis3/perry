...
#all variograms:
Vario(LBC.1~1,soil_points_sp_CID,"Nug")
Vario(P~1,soil_points_sp_CID,"Lin")
Vario(pH.2~1,soil_points_sp_CID,"Exp")
Vario(Ca~1,soil_points_sp_CID,"Sph")
Vario(K~1,soil_points_sp_CID,"Sph")
Vario(Mg~1,soil_points_sp_CID,"Sph")
Vario(Mn~1,soil_points_sp_CID,"Nug")
Vario(Zn~1,soil_points_sp_CID,"Nug")

#kriging: 

#LBC:
LBC_krig_C <- Krig(LBC.1~1,soil_points_sp_CID,"Nug")
#P:
...
#all variograms:
Vario(LBC.1~1,soil_points_sp_SPID,"Nug")
Vario(P~1,soil_points_sp_SPID,"Sph")
Vario(pH.2~1,soil_points_sp_SPID,"Exp")
Vario(Ca~1,soil_points_sp_SPID,"Sph")
Vario(K~1,soil_points_sp_SPID,"Sph")
Vario(Mg~1,soil_points_sp_SPID,"Sph")
Vario(Mn~1,soil_points_sp_SPID,"Nug")
Vario(Zn~1,soil_points_sp_SPID,"Nug")
#LBC:
...
#Mn:
Mn_krig_SP <- Krig(Mn~1,soil_points_sp_SPID,"Nug")
#Zn
