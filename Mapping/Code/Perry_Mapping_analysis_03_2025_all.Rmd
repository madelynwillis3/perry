...
clipped_color_relief_wgs84 <- mask(color_relief_wgs84, border_ext)
...
clipped_hillshade_wgs84 <- mask(hillshade_wgs84, border_ext)
...
soil_points_vect <- vect(soil_points_singlepoint)
...
pH_varfit<-fit.variogram(pH_var, model = vgm("Exp"))
