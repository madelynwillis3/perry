...
# Exclude "x" and "y" from topo_vars
topo_vars_filtered_P <- topo_vars[!topo_vars %in% c("x", "y","Normalized.Height","Standardized.Height","bare_soil_SR_band_1","Mid.Slope.Positon","bare_soil_SR_band_2" ,"bare_soil_SR_band_3","Topographic.Position.Index","viz.USGS1m_aspect","SAVI","NDVI","viz.USGS1m_color.relief_1","Terrain.Ruggedness.Index..TRI.","viz.USGS1m_color.relief_2","viz.USGS1m_hillshade.color_1","bare_soil_SR_band_4","Slope.Height","Topographic.Wetness.Index","MRVBF","viz.USGS1m_hillshade","viz.USGS1m_roughness","viz.USGS1m_hillshade.color_2" )]

# Compute correlation matrix only between soil properties (keeping only P) and filtered topo rasters
cor_matrix_P <- cor(soils_df_wrang[, c("P"), drop = FALSE], soils_df_wrang[, topo_vars_filtered_P], 
                             use = "pairwise.complete.obs", method = "spearman")

# Visualize
ggcorrplot(cor_matrix_P, lab = TRUE, show.legend = TRUE, 
           tl.cex = 5, lab_size = 1.5, tl.srt = 45, method = "square")
ggsave("../Mapping/Output/Correlation_Matrix_P.png", dpi = 300)
...
#""Low K (0-60 lbs/A)"Apply 180 lbs of K2O per acre
#"Medium K (61-150 lbs/A)" Apply 140 lbs of K2O per acre
#"High K (151-250 lbs/A)"Apply 120 lbs of K2O per acre
#"Very High K (250+ lbs/A)" Apply 0 lbs of K2O per acre
...
zone_values_low_res <- rep(NA, ncell(zone_raster_low_res))  # Initialize a vector for zone values nkthe new raster
